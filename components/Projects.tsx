...
export default function Projects(): JSX.Element {
  return (
    <Carousel className='max-w-[1265px]' showThumbs={false} showArrows={true} showIndicators={false} showStatus={false} infiniteLoop={true} swipeable={true} >
      <div className=''>
        <img src="/img/elyx.png" alt="" className="h-96 max-w-[1265px] opacity-0" />
        <div className="w-4/5 p-5 rounded-2xl bg-[#090c16] flex absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
          <div className="w-full flex items-center justify-center">
            <img src="/img/elyx.png" alt="" />
          </div>
          <div className="pl-5 flex flex-col justify-between">
            <div>
              <h1 className="font-semibold font-sans text-xl text-left text-slate-200">Elyx Store</h1>
              <p className="text-sm mt-3 text-slate-400 text-left">
      ...
      <div className=''>
        ...
        <div className="w-4/5 p-5 rounded-2xl bg-[#090c16] flex absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
          ...
          <div className="pl-5 flex flex-col justify-between">
            <div>
              <h1 className="font-semibold font-sans text-xl text-left text-slate-200">Ryp Language</h1>
              <p className="text-sm mt-3 text-slate-400 text-left">
      ...
      <div className=''>
        ...
        <div className="w-4/5 p-5 rounded-2xl bg-[#090c16] flex absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
          ...
          <div className="pl-5 flex flex-col justify-between">
            <div>
              <h1 className="font-semibold font-sans text-xl text-left text-slate-200">Masbro (Deprecated)</h1>
              <p className="text-sm mt-3 text-slate-400 text-left">
